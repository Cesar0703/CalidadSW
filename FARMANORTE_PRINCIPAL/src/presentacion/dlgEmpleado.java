...
public class dlgEmpleado extends javax.swing.JDialog {
   ...
   Object[][] o;
    public dlgEmpleado(java.awt.Frame parent, boolean modal,cEmpleados empleado_) {
        super(parent, modal);
        initComponents();
        listarCargo();
        ...
        int id =Integer.parseInt(empleado_.getCod());
        btnGrabar.setText(id==0?"Agregar":"Modificar");
        btnEliminar.setVisible(id>0);
        lblId.setText(id+"");
        txtnombre.setText(empleado_.getNombre());
        txtapellidoPa.setText(empleado_.getApe_paterno());
        txtapellidoMa.setText(empleado_.getApe_materno());
        try {
            Date date = new SimpleDateFormat("yyy-MM-dd").parse(empleado_.getFechNacimiento());
            dateC.setDate(date);
        } catch (ParseException ex) {
            
        }
        txtDNI.setText(empleado_.getDNI());
        if ((empleado_.getSexo()+"").equals("m")) {
            rbMas.setSelected(true);            
        }else if ((empleado_.getSexo()+"").equals("f")) {
            rbFe.setSelected(true);  
        } 
        txtdireccion.setText(empleado_.getDireccion());
        txttelefono.setText(empleado_.getTelefono());
        txtcorreo.setText(empleado_.getEmail());
        
        comboCargo.setSelectedItem(cargo(empleado_.getCargo()));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(JOptionPane.YES_OPTION==confirmacion){
            EmpleadoDao productodao = new EmpleadoDaoImp();
            productodao.eliminar(Integer.parseInt(lblId.getText()));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        ...
        cEmpleados empleado_ = new cEmpleados("","","","","","","","","","","");
        ...
        if(txtnombre.getText().trim().length()==0){
            ...
            empleado_.setCod(lblId.getText());
            empleado_.setNombre(txtnombre.getText());
            empleado_.setApe_paterno(txtapellidoPa.getText());
            empleado_.setApe_materno(txtapellidoMa.getText());
            empleado_.setFechNacimiento(fechaC);
            empleado_.setDNI(txtDNI.getText());
            empleado_.setSexo((rbMas.isSelected())?"m":"f");
            empleado_.setDireccion(txtdireccion.getText());
            empleado_.setTelefono(txttelefono.getText());
            empleado_.setEmail(txtcorreo.getText());
            empleado_.setCargo(cargoId(comboCargo.getSelectedItem().toString()));
            
            if(Integer.parseInt(empleado_.getCod())>0){
                empleadodao.modificar(empleado_);                
                ...
                empleadodao.insertar(empleado_);
...
char c=evt.getKeyChar(); 
        ...
        List<cCargo> list = cargodao_.list("");
        
        for (cCargo tr : list) {   
            comboCargo.addItem(tr.getNomCargo());
        }
        
        }
        private String cargo(String idCargo){
            List<cCargo> list = cargodao_.list("");
            ...
            for (cCargo tr : list) {   
                ...
                if(idCargo.equals(o[0][i].toString()))
                    return  o[1][i].toString(); 
                i++;
            }                
            return "";
        }
        private String cargoId(String nombreCargo){
            List<cCargo> list = cargodao_.list("");
            o =new Object[2][list.size()];            
            int i = 0;
            for (cCargo tr : list) {   
