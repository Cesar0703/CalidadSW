...
public class dlgLaboratorio extends javax.swing.JDialog {
    ...
    /**
     * Creates new form dlgLaboratorio
     * @param parent
     * @param modal
     * @param laboratorio_
     */
    public dlgLaboratorio(java.awt.Frame parent, boolean modal,cLaboratorio laboratorio_) {
        super(parent, modal);
        initComponents();
        ...
        int id =Integer.parseInt(laboratorio_.getIdLaboratorio());
        btnGrabar.setText(id==0?"Agregar":"Modificar");
        btnEliminar.setVisible(id>0);
        lblCodigo.setText(laboratorio_.getIdLaboratorio());
        txtnombre.setText(laboratorio_.getNomLaboratorio());
        txtDescripcion.setText(laboratorio_.getDescripcionLaboratorio());
    }
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        LaboratorioDao laboratoriodao = new LaboratorioDaoImp();
        cLaboratorio laboratorio_ = new cLaboratorio();
        ...
        if(txtnombre.getText().trim().length()==0){
            ...
            laboratorio_.setIdLaboratorio(lblCodigo.getText());
            laboratorio_.setNomLaboratorio(txtnombre.getText());
            laboratorio_.setDescripcionLaboratorio(txtDescripcion.getText());
            
            if(Integer.parseInt(laboratorio_.getIdLaboratorio())>0){
                laboratoriodao.modificar(laboratorio_);                
                JOptionPane.showMessageDialog(null, "Datos del laboratorio modificados correctamente",FactoryConnectionDb.Mensaje,JOptionPane.INFORMATION_MESSAGE);
            }                
            else{
                laboratoriodao.insertar(laboratorio_);
                JOptionPane.showMessageDialog(null, "Datos del laboratorio ingresados correctamente",FactoryConnectionDb.Mensaje,JOptionPane.INFORMATION_MESSAGE);
            }
            dispose();            
        }  
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int confirmacion = JOptionPane.showConfirmDialog (null, "Desea eliminar este laboratorio?",FactoryConnectionDb.Mensaje,JOptionPane.YES_NO_OPTION);
        if(JOptionPane.YES_OPTION==confirmacion){
            LaboratorioDao mensajedao = new LaboratorioDaoImp();
            mensajedao.eliminar(Integer.parseInt(lblCodigo.getText()));
            JOptionPane.showMessageDialog(null, "Laboratorio eliminado",FactoryConnectionDb.Mensaje,JOptionPane.INFORMATION_MESSAGE);
            dispose();
        }
