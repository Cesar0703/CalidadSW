...
public class frmLaboratorio extends javax.swing.JInternalFrame {
   ...
   Object[][] o;
    public frmLaboratorio() {
        ...
        setTitle("Laboratorio"); //titulo del software
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        int idLaboratorio = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(),0).toString());
        LaboratorioDao proveedordao = new LaboratorioDaoImp();
        dlgLaboratorio dialog = new dlgLaboratorio(new javax.swing.JFrame(), true,proveedordao.buscar(idLaboratorio));
        dialog.setVisible(true);
        listar("");
    }//GEN-LAST:event_jTable1MouseClicked

    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        dlgLaboratorio dialog = new dlgLaboratorio(new javax.swing.JFrame(), true,new cLaboratorio());
        dialog.setVisible(true);
        listar("");
...
private void listar(String texto){
        List<cLaboratorio> list = laboratoriodao_.list(texto);
        o =new Object[3][list.size()];
        int i = 0;
        for (cLaboratorio tr : list) {            
            o[0][i]=tr.getIdLaboratorio()+"";
            o[1][i]=tr.getNomLaboratorio();
            o[2][i]=tr.getDescripcionLaboratorio();  
            i++;
        }
