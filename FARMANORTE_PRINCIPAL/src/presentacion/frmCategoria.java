...
public class frmCategoria extends javax.swing.JInternalFrame {
   ...
   Object[][] o;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        dlgCategoria dialog = new dlgCategoria(new javax.swing.JFrame(), true,categoriadao.buscar(idCategoria));
        dialog.setVisible(true);
        listar("");
    }//GEN-LAST:event_jTable1MouseClicked

    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        dlgCategoria dialog = new dlgCategoria(new javax.swing.JFrame(), true,new cCategoria());
        dialog.setVisible(true);
        listar("");
...
private void listar(String texto){
        List<cCategoria> list = categoriadao_.list(texto);
        o =new Object[3][list.size()];
        int i = 0;
        for (cCategoria tr : list) {            
            o[0][i]=tr.getIdCategoria()+"";
            o[1][i]=tr.getNomCategoria();
            o[2][i]=tr.getDescripcionCategoria();  
            i++;
        }
